...
import { getEmail, getUserById, createThirdPartyUser } from '../modules/userModules.js'
...
passport.deserializeUser( async (id, done) => {
    try {
        ...
        done(null, {username: user.username, user_img: user.user_img, userId: id}) 
    } catch(err) { 
        done(err, false)
    }
})

passport.use('google-register-strategy', new GoogleStrategy({
...
passport.use('google-login-strategy', new GoogleStrategy({
    clientID: GOOGLE_CLIENT_ID,
    clientSecret: GOOGLE_CLIENT_SECRET,
